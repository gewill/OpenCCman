...
#34 stays open for long-running import and conversion presentation, conversion success/failure/cancel, quota/error and Pro presentations, iPhone/iPad VoiceOver and orientations, iOS 15/macOS 12 execution, and the final Xcode Cloud/TestFlight build. Mac import success and invalid-UTF-8 error dismissal are covered in the [import-outcomes record](../issue-34-import-outcomes/README.md); export-panel cancellation and success are covered separately in the [export-panel record](../issue-34-export-panel/README.md). The external preference reset and ad-hoc Debug signature limit this record to presentation coordination, not distribution acceptance.
