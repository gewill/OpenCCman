...
- 按当前配置推荐方案 A：声明购买记录（App Functionality、Analytics）和产品交互（Analytics），两者都“不关联身份”，不追踪。**维护者已于 2026-09-19 选定方案 A**，边界 1、2、4 均按推荐做法处理。
...
| 方法边界 | 2026-09-19 的源码、文档及后台审核未对发布包抓包；2026-09-25 追加了 Cloud 归档隐私报告和导出包清单核对，仍未做网络抓包 |
...
- 2026-09-19：采用方案 A。Device ID（IDFV）、Coarse Location（按 IP 估计国家）、应用自有反馈邮件均不勾选，改为在政策中说明。
...
5. ~~最终签名包的隐私报告仍是独立的发布验收项。~~ 已在 2026-09-25 对 2.0(55) 的 iOS/Mac Cloud 归档生成报告，详见 [Build 55 证据](../validation/build-55/README.md)。报告无清单字段错误；导出包中的清单与归档一致。此项不替代真实购买验收或发布后 URL 回读。
