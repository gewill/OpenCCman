...
@main struct MinimalLifetimeApp: App {
  ...
  var body: some Scene { WindowGroup("Minimal Observed Probe", id: "lifetime") { ProbeRoot().background(LifetimeDriverView()) } }
}
