...
- [1/10 MiB document cycles](2026-09-15-documents/README.md) passed four full-byte import/convert/export checks and the five-conversion quota check. The native document models remained alive at ~20s; after the 10 MiB cycle physical footprint was 8.54 GiB. This is an unresolved performance finding, not an improvement. A later zero-window interval was isolated from UI activation and recorded; active-task close and reopen remain pending. #18 and #93 stay open.
